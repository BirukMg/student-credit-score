  ...
  <div class="flexible-content">
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <list-group class="list-group-flush">
        <router-link to="/teacher/mysection" @click.native="activeItem = 1">
          <list-group-item :action="true" :class="activeItem === 1 && 'active'"><fa icon="users" class="mr-3"/>My students</list-group-item>
        </router-link>
        <router-link to="/teacher/profile" @click.native="activeItem = 2">
